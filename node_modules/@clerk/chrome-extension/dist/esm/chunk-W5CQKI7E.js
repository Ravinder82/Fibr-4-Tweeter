import { __export, __export2, __reExport, buildErrorThrower, createDevOrStagingUrlCache, createClerkClient, isClerkAPIResponseError, ClerkRuntimeError, isPublishableKey } from './chunk-DVUXKDPV.js';
import React8, { createContext, useContext, useMemo, useRef, useEffect, useLayoutEffect, createElement, useCallback, useDebugValue, useState } from 'react';
...
var OrganizationProvider = ({
  ...
  return /* @__PURE__ */ React8.createElement(clerk_swr_exports.SWRConfig, { value: swrConfig }, /* @__PURE__ */ React8.createElement(
...
function useAssertWrappedByClerkProvider(displayNameOrFn) {
  const ctx = React8.useContext(ClerkInstanceContext);
  if (!ctx) {
...
var useSession = (options = {}) => {
  ...
  const pendingAsSignedOut = (session == null ? void 0 : session.status) === "pending" && ((_a = options.treatPendingAsSignedOut) != null ? _a : clerk.__internal_getOption("treatPendingAsSignedOut"));
...
// ../shared/dist/chunk-BX3IAZDX.mjs
...
var useCustomElementPortal = (elements) => {
  ...
  return elements.map((el, index) => ({
    ...
    portal: () => /* @__PURE__ */ React8.createElement(React8.Fragment, null, nodes[index] ? createPortal(el.component, nodes[index]) : null)
  }));
};
...
function ClerkContextProvider(props) {
  ...
  return (
    ...
    /* @__PURE__ */ React8.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ React8.createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ React8.createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ React8.createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ React8.createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ React8.createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
var useLoadedIsomorphicClerk = (options) => {
  const isomorphicClerk = React8.useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
  const [clerkStatus, setStatus] = React8.useState(isomorphicClerk.status);
  React8.useEffect(() => {

...
// ../shared/dist/chunk-NT4JRXL3.mjs
...
// ../shared/dist/chunk-D7I6IBIF.mjs
...
// ../shared/dist/chunk-QU372XZW.mjs
...
// ../shared/dist/chunk-IBXKDGSZ.mjs
...
// ../shared/dist/chunk-7QJ2QTJL.mjs
...
// ../shared/dist/chunk-43A5F2IE.mjs
...
var OrganizationProvider = ({
  ...
  return /* @__PURE__ */ React8__default.default.createElement(clerk_swr_exports.SWRConfig, { value: swrConfig }, /* @__PURE__ */ React8__default.default.createElement(
...
function useAssertWrappedByClerkProvider(displayNameOrFn) {
  const ctx = React8__default.default.useContext(ClerkInstanceContext);
  if (!ctx) {
...
var useWithSafeValues = (params, defaultValues) => {
  ...
  const initialPageRef = React8.useRef(
...
var usePagesOrInfinite = (params, fetcher, config, cacheKeys) => {
  ...
  const [paginatedPage, setPaginatedPage] = React8.useState((_a = params.initialPage) != null ? _a : 1);
  const initialPageRef = React8.useRef((_b = params.initialPage) != null ? _b : 1);
  const pageSizeRef = React8.useRef((_c = params.pageSize) != null ? _c : 10);
  ...
  const fetchPage = React8.useCallback(
    (numberOrgFn) => {
      if (triggerInfinite) {
...
function useOrganization(params) {
  ...
  (_a = clerk2.telemetry) == null ? void 0 : _a.record(eventMethodCalled("useOrganization"));
...
function useOrganizationList(params) {
  ...
  (_a = clerk2.telemetry) == null ? void 0 : _a.record(eventMethodCalled("useOrganizationList"));
  ...
  return {
    ...
    setActive: clerk2.setActive,
    createOrganization: clerk2.createOrganization,
...
var useSession = (options = {}) => {
  ...
  const pendingAsSignedOut = (session == null ? void 0 : session.status) === "pending" && ((_a = options.treatPendingAsSignedOut) != null ? _a : clerk2.__internal_getOption("treatPendingAsSignedOut"));
...
var useReverification = (fetcher, options) => {
  ...
  const handleReverification = React8.useMemo(() => {
...
// ../shared/dist/chunk-7HPDNZ3R.mjs
...
// ../shared/dist/chunk-UEY4AZIP.mjs
...
var RedirectToSignIn = withClerk(({ clerk: clerk2, ...props }) => {
  ...
  React8__default.default.useEffect(() => {
    if (session === null && hasSignedInSessions) {
      ...
      void clerk2.redirectToSignIn(props);
    }
  }, []);
  return null;
}, "RedirectToSignIn");
...
// ../shared/dist/chunk-ARQUL5DC.mjs
...
// ../shared/dist/chunk-O32JQBM6.mjs
...
// ../shared/dist/chunk-CFXQSUF6.mjs
...
// ../shared/dist/chunk-ZIXJBK4O.mjs
...
// ../shared/dist/chunk-JKSAJ6AV.mjs
function inBrowser() {
  return typeof window !== "undefined";
}

// ../shared/dist/chunk-GVKBGR5N.mjs
...
var useCustomElementPortal = (elements) => {
  ...
  const [nodes, setNodes] = React8.useState(initialState);
  return elements.map((el, index) => ({
    ...
    portal: () => /* @__PURE__ */ React8__default.default.createElement(React8__default.default.Fragment, null, nodes[index] ? reactDom.createPortal(el.component, nodes[index]) : null)
  }));
};
...
var CustomPortalsRenderer = (props) => {
  var _a, _b;
  return /* @__PURE__ */ React8__default.default.createElement(React8__default.default.Fragment, null, (_a = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a.map((portal, index) => React8.createElement(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => React8.createElement(portal, { key: index })));
};
...
var SignInButton = withClerk(
  ({ clerk: clerk2, children, ...props }) => {
    ...
    const clickHandler = () => {
      ...
      if (mode === "modal") {
        return clerk2.openSignIn({ ...opts, appearance: props.appearance });
      }
      return clerk2.redirectToSignIn({
        ...opts,
...
var SignUpButton = withClerk(
  ({ clerk: clerk2, children, ...props }) => {
    ...
    const clickHandler = () => {
      ...
      if (mode === "modal") {
        return clerk2.openSignUp({ ...opts, appearance: props.appearance });
      }
      return clerk2.redirectToSignUp({
        ...opts,
...
var SignOutButton = withClerk(
  ({ clerk: clerk2, children, ...props }) => {
    ...
    const clickHandler = () => clerk2.signOut({ redirectUrl, ...signOutOptions });
    const wrappedChildClickHandler = async (e) => {
      await safeExecute(child.props.onClick)(e);
      return clickHandler();
    };
  ...
  ({ clerk: clerk2, children, ...props }) => {
    ...
    const clickHandler = async () => {
      async function authenticate() {
        await clerk2.authenticateWithMetamask({ redirectUrl: redirectUrl || void 0 });
      }
      void authenticate();
    };
    const wrappedChildClickHandler = async (e) => {
...
function ClerkContextProvider(props) {
  ...
  return (
    ...
    /* @__PURE__ */ React8__default.default.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ React8__default.default.createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ React8__default.default.createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ React8__default.default.createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ React8__default.default.createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ React8__default.default.createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
var useLoadedIsomorphicClerk = (options) => {
  const isomorphicClerk = React8__default.default.useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
  const [clerkStatus, setStatus] = React8__default.default.useState(isomorphicClerk.status);
  React8__default.default.useEffect(() => {
...
var errorThrower3 = buildErrorThrower({ packageName: "@clerk/chrome-extension" });
var missingManifestKeyError = (key) => `Missing \`${key}\` entry in manifest.json`;
function assertPublishableKey(publishableKey) {
  if (!publishableKey) {
    errorThrower3.throwMissingPublishableKeyError();
  }
}
...
function validateRootManifestKey(manifest, key) {
  if (!manifest[key]) {
    errorThrower3.throw(missingManifestKeyError(key));
  }
}
function validateManifestPermission(manifest, key) {
  var _a;
  if (!((_a = manifest.permissions) == null ? void 0 : _a.includes(key))) {
    errorThrower3.throw(missingManifestKeyError(`permissions.${key}`));
  }
}
...
exports.ClerkDegraded = ClerkDegraded;
exports.ClerkFailed = ClerkFailed;
...
exports.RedirectToCreateOrganization = RedirectToCreateOrganization;
exports.RedirectToOrganizationProfile = RedirectToOrganizationProfile;

...
Share your authentic thread now:`;
    ...
    getDefaultToneInstructions: function(toneId) {
      const defaultTones = {
        ...
        'content-like-this': 'TONE: Shuffle\nPerform deep analysis of the webpage content to extract its template structure, main focus element, audience sophistication, and value delivery mechanism. Generate expert-quality content that preserves the exact template while intelligently substituting the main focus element with a contextually aligned, professionally credible alternative that serves the same audience with the same engagement appeal and practical value.',
